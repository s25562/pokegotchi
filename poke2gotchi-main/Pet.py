...
class Pet:
    ...
    def __init__(self, name):
        ...
        self.hunger_increment_interval: int = 20000
        self.happiness_increment_interval: int = 1000
        self.sleepness_increment_interval: int = 3000
    ...
    def sleep(self) -> None:
        ...
        if self.sleepiness < 100:
            self.sleepiness = min(self.sleepiness + 10, 100)
    ...
    def update(self) -> bool:
        ...
        if self.hunger_timer >= self.hunger_increment_interval:
            self.hunger = min(self.hunger - 3, 100)
            self.hunger_timer = 0
        ...
        if self.happiness <= 0 or self.hunger <= 0  or self.sleepiness <= 0:
            return True
